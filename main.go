...
// Sample exotic deck
var Deck = []Card{
	{"Dragon", map[string]int{"Strength": 95, "Speed": 60, "Magic": 90}, "https://via.placeholder.com/150/FF6B6B/FFFFFF?text=🐉+Dragon"},
	{"Phoenix", map[string]int{"Strength": 70, "Speed": 80, "Magic": 95}, "https://via.placeholder.com/150/FF8E53/FFFFFF?text=🔥+Phoenix"},
	{"Unicorn", map[string]int{"Strength": 65, "Speed": 75, "Magic": 85}, "https://via.placeholder.com/150/4ECDC4/FFFFFF?text=🦄+Unicorn"},
	{"Griffin", map[string]int{"Strength": 80, "Speed": 70, "Magic": 60}, "https://via.placeholder.com/150/45B7D1/FFFFFF?text=🦅+Griffin"},
	{"Kraken", map[string]int{"Strength": 85, "Speed": 50, "Magic": 80}, "https://via.placeholder.com/150/96CEB4/FFFFFF?text=🐙+Kraken"},
	{"Chimera", map[string]int{"Strength": 75, "Speed": 65, "Magic": 70}, "https://via.placeholder.com/150/FECA57/FFFFFF?text=🦁+Chimera"},
}
