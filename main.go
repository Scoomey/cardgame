...
// Sample exotic deck
var Deck = []Card{
	{"Dragon", map[string]int{"Strength": 95, "Speed": 60, "Magic": 90}, "https://picsum.photos/150/150?random=1"},
	{"Phoenix", map[string]int{"Strength": 70, "Speed": 80, "Magic": 95}, "https://picsum.photos/150/150?random=2"},
	{"Unicorn", map[string]int{"Strength": 65, "Speed": 75, "Magic": 85}, "https://picsum.photos/150/150?random=3"},
	{"Griffin", map[string]int{"Strength": 80, "Speed": 70, "Magic": 60}, "https://picsum.photos/150/150?random=4"},
	{"Kraken", map[string]int{"Strength": 85, "Speed": 50, "Magic": 80}, "https://picsum.photos/150/150?random=5"},
	{"Chimera", map[string]int{"Strength": 75, "Speed": 65, "Magic": 70}, "https://picsum.photos/150/150?random=6"},
}
